...
public class PLView extends PLViewBase
{
	...
	public RelativeLayout getControlsLayout()
	{
		if(controlsLayout == null)
		{
			...
			this.addContentView(controlsLayout, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
		}
	...
	public boolean showProgressBar()
	{
		if(progressBar == null)
		{
			...
			this.getControlsLayout().setVisibility(View.VISIBLE);
			this.getControlsLayout().bringToFront();
			return true;
		}
		return false;
	}
	...
	public boolean hideProgressBar()
	{
		if(progressBar != null)
		{
			...
			this.getControlsLayout().setVisibility(View.GONE);
			progressBar = null;
			return true;
		}
		return false;
