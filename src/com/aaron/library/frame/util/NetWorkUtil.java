...
//		String url = "http://webservice.webxml.com.cn/WebServices/IpAddressSearchWebService.asmx?WSDL";
//		Map<String,String> params = new HashMap<String, String>();
//		params.put("theIpAddress", "203.156.252.27");
//		FormWebService.requestWebService(url, "http://WebXml.com.cn/", "getCountryCityByIp", params);
//		try {
//			URL infoUrl = new URL("http://iframe.ip138.com/ic.asp");
//			URLConnection connection = infoUrl.openConnection();
//			HttpURLConnection httpConnection = (HttpURLConnection)connection;
//			httpConnection.setConnectTimeout(5);
...
//					start = strber.indexOf("：",end);
//					end = strber.indexOf(" ",start+1);
//					address = strber.substring(start + 1, end);
//				}
//System.out.println("dddddddd========>  "+line+"  "+address);
//				return new String[]{line,address};
//			}
//		}catch(Exception e) {
//			e.printStackTrace();
//		}
